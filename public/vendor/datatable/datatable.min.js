...
*/
(function(b){"function"===typeof define&&define.amd?define(["jquery","datatables.net"],function(a){return b(a,window,document)}):"object"===typeof exports?module.exports=function(a,d){a||(a=window);if(!d||!d.fn.dataTable)d=require("datatables.net")(a,d).$;return b(d,a,a.document)}:b(jQuery,window,document)})(function(b,a,d,m){var f=b.fn.dataTable;b.extend(!0,f.defaults,{dom:"<'row mb-0'<'col-sm-12 col-md-6'l><'col-sm-12 col-md-6'f>><'row'<'col-sm-12'tr>><'row'<'col-sm-12 col-md-5'i><'col-sm-12 col-md-7'p>>",
...
window.loadDataTable = function loadDataTable (wrapper, url, successCallback, errorCallback) {
  if (typeof errorCallback !== 'function') {
    throw new Error('[ERROR] The errorCallback parameter must be a function.');
  }
  ...
  $.ajax({
    ...
    success: function (response) {
      ...
      successCallback($('successCallback').find('table'));
    },
...
window.createDataTable = function createDataTable (el, ignore) {
  var _ignore = [];

  $.each(ignore, function (index, val) {
    _ignore.push({ orderable: false, targets: val })
  });
