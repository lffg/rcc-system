...
class EditUser {
  ...
  get messages () {
    return {
      ...
      'password.required'          : 'A senha fornecida ultrapassa o limite de 50 caracteres.',
      ...
      'temporary_bonuses.required' : 'O campo de gratificações temporárias é obrigatório.',
      'temporary_bonuses.integer'  : 'Número de medalhas inválido em "gratificações temporárias".',
      'effective_bonuses.required' : 'O campo de gratificações efetivas é obrigatório.',
      'effective_bonuses.integer'  : 'Número de medalhas inválido em "gratificações efettivas".'
    }
  }
